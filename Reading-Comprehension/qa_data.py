...
def basic_tokenizer(sentence):
    ...
    for space_separated_fragment in sentence.strip().split():
        words.extend(re.split(b" ", space_separated_fragment.encode()))
...
if __name__ == '__main__':
    ...
    answer_train_ids_path = train_path + ".ids.answer"
    answer_ids_path = valid_path + ".ids.answer"
    data_to_token_ids(train_path + ".answer", answer_train_ids_path, vocab_path)
    data_to_token_ids(valid_path + ".answer", answer_ids_path, vocab_path)